              ...
              <nav class="flex-1">
                ...
                <div class="relative transition">
                  ...
                  <button
                    ...
                    class="flex peer relative w-full items-center border-l-rose-600 py-3 px-4 text-md font-medium text-gray-600 outline-none transition-all duration-100 ease-in-out hover:border-l-4 hover:text-rose-600 focus:border-l-4"
                  >
                    <span class="flex mr-5 w-5  text-md font-medium text-gray-600">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-5 w-5"
                        fill="none"
            ...
            <div className="mb-4 ">
              <nav class="flex-1 ">
                <div
                  ...
                  class="flex cursor-pointer items-center border-l-rose-600 py-2 px-4 text-md font-medium text-rose-600 outline-none transition-all duration-100 ease-in-out hover:border-l-4 hover:border-l-rose-600 hover:text-rose-600 focus:border-l-4"
                >
